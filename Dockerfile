...
COPY /var/lib/jenkins/.m2/repository/com/javainuse/spring-boot-aop/0.0.1-SNAPSHOT/spring-boot-aop-0.0.1-SNAPSHOT.jar /home/dswain/target_jar/spring-boot-aop-0.0.1-SNAPSHOT.jar
#ENTRYPOINT ["java","-Djava.security.egd=file:/dev/./urandom","-jar","/usr/local/jetty/webapps/spring-boot-aop-0.0.1-SNAPSHOT.jar"]
ENTRYPOINT ["java","-Djava.security.egd=file:/dev/./urandom","-jar","/home/dswain/target_jar/spring-boot-aop-0.0.1-SNAPSHOT.jar"]
