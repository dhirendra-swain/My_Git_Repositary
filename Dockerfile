...
COPY /var/lib/jenkins/.m2/repository/com/javainuse/spring-boot-aop/0.0.1-SNAPSHOT/spring-boot-aop-0.0.1-SNAPSHOT.jar /usr/local/myjettyserver/spring-boot-aop-0.0.1-SNAPSHOT.jar
